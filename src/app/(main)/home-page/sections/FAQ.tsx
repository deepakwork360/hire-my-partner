          ...
          {faqData.map((faq, index) => (
            ...
            >
              <button
                ...
                className="w-full px-8 cursor-pointer  py-6 flex items-center justify-between text-left group"
              >
                <span
                ...
                <div
                  className={`w-10 h-10 rounded-full flex items-center justify-center border transition-all duration-500 ${
                    openIndex === index
                      ? "bg-linear-to-br from-primary to-primary-dark border-primary-dark rotate-180"
