  ...
  return (
    <div className={`${outfit.className}`}>
      ...
      >
        ...
        {/* Desktop Table */}
        <div className="relative overflow-x-auto rounded-[24px] border border-white/10 overflow-hidden shadow-2xl">
           <table className="w-full text-left min-w-[700px]">
              <thead className="bg-linear-to-r from-primary-dark via-primary to-accent text-white">
                 <tr className="uppercase font-black text-[10px] xl:text-[11px] tracking-widest">
                    <th className="px-6 xl:px-8 py-5 xl:py-7 border-r border-white/10">User</th>
                    <th className="px-6 xl:px-8 py-5 xl:py-7 border-r border-white/10">Date</th>
                    <th className="px-6 xl:px-8 py-5 xl:py-7 border-r border-white/10">Time</th>
                    <th className="px-6 xl:px-8 py-5 xl:py-7 border-r border-white/10">Event Type</th>
                    ...
                    >
                       <td className="px-6 xl:px-8 py-5 xl:py-7 border-r border-white/5">
                          <div className="flex items-center gap-3">
                             <div className="relative w-10 h-10 xl:w-12 xl:h-12 rounded-full overflow-hidden border border-white/10 ring-2 ring-transparent group-hover:ring-primary/50 group-hover:shadow-[0_0_15px_rgba(var(--primary-rgb),0.4)] transition-all">
                                <Image src={row.img} alt={row.user} fill className="object-cover" />
                             </div>
                             <span className="text-white text-sm xl:text-base font-bold group-hover:text-primary transition-colors uppercase tracking-tight">{row.user}</span>
                          </div>
                       </td>
                       <td className="px-6 xl:px-8 py-5 xl:py-7 border-r border-white/5">
                          <div className="inline-flex px-4 py-1.5 rounded-full bg-linear-to-r from-primary/10 to-transparent border border-primary/10 text-slate-300 text-xs xl:text-sm font-medium">
                             {row.date}
                          </div>
                       </td>
                       <td className="px-6 xl:px-8 py-5 xl:py-7 border-r border-white/5">
                          <div className="inline-flex px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-slate-500 text-xs xl:text-sm font-medium italic">
                             {row.time}
                          </div>
                       </td>
                       <td className="px-6 xl:px-8 py-5 xl:py-7 border-r border-white/5">
