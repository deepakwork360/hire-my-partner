...
export default function PrivacyEffectiveDate() {
  return (
    <section className={`py-12 md:py-16 px-4 bg-bg-base relative overflow-hidden ${outfit.className}`}>
      <div className="max-w-4xl mx-auto relative z-10">
        <motion.div
          ...
          className="relative bg-bg-card backdrop-blur-3xl border border-border-main rounded-[48px] p-8 md:p-16 overflow-hidden shadow-2xl shadow-black/5"
        >
          ...
          <div className="relative z-10 flex flex-col items-center text-center space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-bg-secondary border border-border-main">
                <Clock className="w-3.5 h-3.5 text-text-muted" />
                <span className="text-[10px] uppercase font-black tracking-[0.2em] text-text-muted">
                  Last Updated: <span className="text-text-main">April 17, 2026</span>
                </span>
              </div>
            </div>
