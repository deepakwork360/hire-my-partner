      ...
      <div className="max-w-[1600px] w-full mx-auto flex flex-col md:flex-row items-center gap-16 md:gap-24">
        ...
        <div className="w-full md:w-1/2">
          <motion.h2
            ...
            viewport={{ once: true }}
            className={`${rochester.className} text-center md:text-left text-4xl md:text-6xl font-bold text-transparent bg-clip-text bg-linear-to-r from-primary via-accent to-primary animate-in fade-in slide-in-from-bottom-4 duration-700 py-4 leading-[1.2] mb-6`}
          >
            Ready To Hire <span className="text-accent"> Or Be Hired?</span>
          </motion.h2>
