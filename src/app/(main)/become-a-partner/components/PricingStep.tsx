      ...
      <div className="space-y-4">
        ...
        <InputWrapper>
          <div className="relative group">
            <div className={`absolute left-5 top-1/2 -translate-y-1/2 font-bold text-lg transition-colors ${showErrors && errors?.hourlyRate ? "text-red-500" : "text-text-muted group-focus-within:text-primary"}`}>
              ₹
            </div>
            <input
              type="number"
              placeholder="Hourly Rate"
              className={`${getInputClass(showErrors && !!errors?.hourlyRate)} pl-14 md:pl-14`}
