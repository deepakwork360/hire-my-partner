  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10 w-full flex flex-col items-center">
        ...
        <div className="w-full flex flex-col items-center mb-10 relative text-center">
          ...
          >
            ...
            <p className="text-text-muted max-w-xl">
              Review the details of your active session and proceed to show your appreciation.
            </p>
          </motion.div>
        </div>
          ...
          <div className="w-full md:w-1/2 p-8 md:p-14 flex flex-col justify-between relative bg-bg-secondary">
            <div className="relative">
              ...
              <div className="grid grid-cols-2 gap-8 px-2">
                ...
                {/* QUOTE / DETAIL - PORTED FROM SEND-GIFT */}
            ...
            {/* View Profile Action - Styled like Book Now */}
        ...
        {/* Decorative Divider */}
        <div className="mt-16 h-px w-[200px] bg-linear-to-r from-transparent via-white/10 to-transparent" />
      </div>
    </section>
  );
}
